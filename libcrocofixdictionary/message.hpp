...
public:
    ...
    message(std::string_view name, std::string_view msg_type, std::string_view category, std::string_view added)
    : m_name(name), m_msg_type(msg_type), m_category(category), m_added(added) 
    {
    }
